...
insert into tb_tecnologia  values 
  (default, 'Aplicações Web', 'Engloba todas as tecnologias de desenvolvimento de sistemas web e sites'),
  (default, 'Aplicações Desktop', 'Engloba todas as tecnologias de desenvolvimento de sistemas desktop'),
  (default, 'Aplicações Mobile', 'Engloba todas as tecnologias de desenvolvimento de sistemas mobile (aplicativos de celular)'),
  (default, 'Aplicações Embarcado (IOT)', 'Engloba todas as tecnologias de desenvolvimento de sistemas IOT'),
  (default, 'Aplicações com arduíno', 'Desenvolvimento voltado para a microcontroladora chamada arduino.'),
  (default, 'ASP.NET', 'ASP.NET é a plataforma da Microsoft para o desenvolvimento de aplicações Web e é o sucessor da tecnologia ASP.'),
  (default, 'Angular', 'Framework de Javascript para desenvolver SPA'),
  ...
  (default, 'CSS', 'Linguagem de estilização voltada para web'),
  (default, 'Chatbot', 'Voltada para desenvolvimento de interações com um bot em chat com IA'),
  ...
  (default, 'Crystal', 'Crystal é uma linguagem de programação multiparadigma compilada de tipagem estática e sintaxe fortemente inspirada em Ruby,[3] e em C#, Go, Python e Rust.'),
  (default, 'Dart', 'Linguagem de programação desenvolvida pela Google para desenvolvimento web'),
  (default, 'Elixir', 'Elixir é uma linguagem de programação funcional, concorrente, de propósito geral que executa na máquina virtual Erlang (BEAM).'),
  (default, 'Erlang', 'Erlang é uma linguagem de programação de uso geral e um sistema para execução.'),
  (default, 'F#', 'F# é uma linguagem de programação multiparadigma para a plataforma .NET, que engloba programação funcional, imperativa e orientada a objetos.'),
  (default, 'Flutter', 'Desenvolvimento de aplicações mobile hibridas, além de desktop e web.'),
  ...
  (default, 'GraphQL', 'GraphQL é uma linguagem de consulta criada pelo Facebook em 2012 e lançada publicamente em 2015. É considerada uma alternativa para arquiteturas REST, além de oferecer um serviço runtime para rodar comandos e consumir uma API.'),
  (default, 'Haskell', 'Haskell é uma linguagem de programação puramente funcional, de propósito geral, nomeada em homenagem ao lógico Haskell Curry.'),
  (default, 'HTML', 'Linguagem de marcação de texto, voltada para aplicações web'),
  (default, 'Inteligência Artificial', 'Envolve tecnologias voltadas para a àrea de IA'),
  ...
  (default, 'Julia', 'Julia é uma linguagem de programação dinâmica de alto nível projetada para atender os requisitos da computação de alto desempenho numérico e científico, sendo também eficaz para a programação de propósito geral.'),
  ...
  (default, 'Laravel', 'Framework PHP para desenvolvimento de sistemas MVC'),
  ...
  (default, 'NoSQL', 'Linguagem adotada pela maioria dos bancos não relacionais'),
  ...
  (default, 'Q#', 'Q# (pronuncia-se como Q sharp) é uma linguagem de programação de domínio específico usada para expressar algoritmos quânticos. Ele foi inicialmente lançado para o público pela Microsoft como parte do Kit de Desenvolvimento Quantum'),
  (default, 'R', 'R é um ambiente computacional e uma linguagem de programação que vem progressivamente se especializando em manipulação, análise e visualização gráfica de dados'),
  ...
  (default, 'Shellscript', 'Linguagem de scripts em baixo nível'),
